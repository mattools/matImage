function degree = getNodeDegree(node, edges)
%GETNODEDEGREE return degree of a node in a (undirected) graph
%
%   DEG = getNodeDegree(NODE_INDEX, EDGES);
...
%   getNodeDegree(1:size(nodes, 1), edges)
%
%   See Also: getNodeInnerDegree, getNodeOuterDegree
%
%
% ------
