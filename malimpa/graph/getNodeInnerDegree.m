function degree = getNodeInnerDegree(node, edges)
%GETNODEINNERDEGREE return inner degree of a node in a graph
%
%   DEG = getNodeInnerDegree(NODE, EDGES);
%   Returns the inner degree of a node in the given edge list, ie. e. the
...
%
%   See Also:
%   getNodeDegree, getNodeOuterDegree
%
%
% ------
