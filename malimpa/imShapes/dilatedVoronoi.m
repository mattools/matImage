...
%   DIM can be either:
%   - a 1x2 row vector containing number of pixels in each direction
%   - a 2x3 matrix contaning starting position, position increment, and end
