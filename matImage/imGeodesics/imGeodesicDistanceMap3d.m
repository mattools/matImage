function dist = imGeodesicDistanceMap3d(img, varargin)
%IMGEODESICDISTANCEMAP3D Geodesic distance transform for 3D binary or label images
%
%   RES = imGeodesicDistanceMap3d(IMG, MARKERS);
...
%
%   RES = imGeodesicDistanceMap3d(IMG);
...
%
%   RES = imGeodesicDistanceMap3d(..., WEIGHTS);
...
%       voxels.
%
%   RES = imGeodesicDistanceMap3d(..., 'verbose', true);
...
%     dist = imGeodesicDistanceMap3d(img, marker);
...
%     dist = imGeodesicDistanceMap3d(img, marker, [3 4 5]);
%     dist(10, 10, 50) / 3
%     ans =
%         229.3333
%
%   See also
%   imGeodesics, imGeodesicDistanceMap, imGeodesicDistance
...
%   HISTORY
%   2018.03.05 rename from imChamferDistance3d to imGeodesicDistanceMap3d
