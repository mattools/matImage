function [ellipsoid, labels] = imEquivalentEllipsoid(img, varargin)
% Equivalent ellipsoid of a 3D binary image.
%
%   ELLI = imEquivalentEllipsoid(IMG)
%   Where IMG is a binary image of a single particle or region.
%   ELLI = [XC YC ZC A B C PHI THETA PSI] is an ellipsoid defined by its
%   center [XC YC ZC], 3 radiusse A, B anc C, and a 3D orientation angle
%   given by (PHI, THETA, PSI).
%
%   ELLI = imEquivalentEllipsoid(LBL)
...
%
%   ELLI = imEquivalentEllipsoid(..., SPACING)
...
%   direction.
%
%   ELLI = imEquivalentEllipsoid(..., LABELS)
...
%     elli2 = imEquivalentEllipsoid(img)
%     elli2 =
...
%     
%   See also
%     imPrincipalAxes, imEquivalentEllipse, equivalentEllipsoid,
...
if ~isIntensity
    ...
    % Computes equivalent ellipsoid of the whole image with weights
