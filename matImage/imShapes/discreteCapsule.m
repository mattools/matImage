...
%   each coordinate. 
%   CAPSULE has the following format: [X1 Y1  X2 Y2  R]
%   (X1,Y1) is the starting point of the capsule
%   (X2,Y2) is the ending point of the capsule
...
%
%   See also
%   imShapes, discreteDisk, discreteRectangle, discreteCapsule3d
%
