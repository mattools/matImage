function [header, data] = headerLoad(file)
...
%
%     Note: got from Matlab technotes support no 1402
...
[data, ncols, errmsg, nxtindex] = sscanf(line, '%f'); %#ok<ASGLU>
...
% array of spaces.
header = repmat(' ', no_lines, max_line);
for i = 1:no_lines
